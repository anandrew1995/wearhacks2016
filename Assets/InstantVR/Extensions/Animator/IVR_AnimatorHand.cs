...
public class IVR_AnimatorHand : IVR_Controller {
    ...
    private void FollowHip() {
        ...
        this.position = hipLocalPosition - (hipLocalRotation * hip2hand);
        this.rotation = hipLocalRotation * startRotation;
    }
    ...
    protected void ArmSwingAnimation() {
        ...
        if (curSpeedZ < 0.01f || curSpeedZ > 0.01f) {
            ...
            if (this.transform == ivr.leftHandTarget) {
                ...
                this.rotation *= Quaternion.AngleAxis((localFootZ * 160 + 10), Quaternion.Inverse(ivr.transform.rotation) * -transform.forward);
            } else {
            ...
            this.position = new Vector3(newPosition.x, newY, newPosition.z);
        }
    }
