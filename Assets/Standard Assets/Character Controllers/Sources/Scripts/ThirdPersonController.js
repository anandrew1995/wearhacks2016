...
function moveTowardsUser ()
{
	...
	var v = movementVector.x;
	var h = movementVector.z;
	...
	// Grounded controls
		...
		// moveDirection is always normalized, and we only update it if there is user input.
			...
			Debug.Log ("Reached Target Movement");
			moveDirection = Vector3.RotateTowards(moveDirection, -movementVector, rotateSpeed * Mathf.Deg2Rad * Time.deltaTime, 1000);
